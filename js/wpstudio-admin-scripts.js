jQuery(document).ready(function($){
	...
	- get the id from the selected input
  	...
  	*/
	$(document).on( 'click', '.wpstudio-show-image input', function() {
      ...
      if ( input_val == 1 ) {
        $( '#' + widget_id_prefix + 'wpstudio-background-fixed' ).hide();
      }
  	 	if ( input_val == 3 ) {
  	 		$( '#' + widget_id_prefix + '-toggle_uploader' ).show();
  	 		$( '#' + widget_id_prefix + '-toggle_image_size' ).hide();
  	 		$( '#' + widget_id_prefix + '-toggle_background_color' ).hide();
        	$( '#' + widget_id_prefix + '-toggle_background_fixed' ).show();
  	 	} else if ( input_val == 2 ) {
        	...
        	$( '#' + widget_id_prefix + '-toggle_background_color' ).hide();
  	 	  	...
  	 	  	$( '#' + widget_id_prefix + '-toggle_uploader' ).hide();
  	 	  	$( '#' + widget_id_prefix + '-toggle_image_size' ).hide();
          	$( '#' + widget_id_prefix + '-toggle_background_fixed' ).hide();
          	$( '#' + widget_id_prefix + '-toggle_background_color' ).hide()
  	 	} else if ( input_val == 4 ) {
  	 		$( '#' + widget_id_prefix + '-toggle_background_color' ).show();
  	 	  	$( '#' + widget_id_prefix + '-toggle_uploader' ).hide();
  	 	  	$( '#' + widget_id_prefix + '-toggle_image_size' ).hide();
          	$( '#' + widget_id_prefix + '-toggle_background_fixed' ).hide();
  	 	}
